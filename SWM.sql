...
--
-- Host: localhost
-- Generation Time: May 06, 2024 at 06:29 AM
...
INSERT INTO `Cust_Pages` (`Thread_ID`, `Sub_Thread_ID`, `PID`, `Title`, `Body`, `Last_Modified`, `Last_Author`) VALUES
...
INSERT INTO `Cust_Pages_DATA` (`Thread_ID`, `Sub_Thread_ID`, `Active`) VALUES
(1, 15, 1),
(2, 1, 1);
...
INSERT INTO `SubMenus` (`MenuID`, `LinkID`, `Menu_Entry`, `Title`, `Active`) VALUES
(1, 1, 'Home', 'index.php', 1),
(1, 3, 'News', 'news.php', 1),
(1, 4, 'Page 1', 'index.php?page=Page 1', 1);
...
(35, 'Joseph', 'Pinzone', 'jrpinzone@yahoo.com', 'admin', '$2y$10$eZK.6hAn.eqdDx1uuKU/tee4jzLRWzknnCgvsNN7DQh9rM20V4Zey', '$2y$10$BFBfu5lIRrr5oYVouelvO.XYfxGx3vQVj2ZCNut1yRNtKdwOck6Nq', '$2y$10$Yr34a2gba0mWN9BJMKme.e5vx.Z8Bdw.L2lqrGvqc75atvCBphUCq', '2024-04-30 16:48:43', NULL, NULL, '2024-04-02 20:52:43', '2024-05-06 15:23:31', 3, 1),
